...
async def hello(client: app, message):
    buttons = [
           [
                InlineKeyboardButton("⚡𝙾𝚆𝙽𝙴𝚁 💕⚡", url="t.me/SUCHA_YAAR_1"),
            ],
            [
                InlineKeyboardButton("⚡𝙲𝙷𝙰𝙽𝙽𝙴𝙻 💕⚡", url="t.me/FRIENDS_CHATTING_ZONE_II"),
            ],
            [
                InlineKeyboardButton("⚡𝚂𝚄𝙿𝙿𝙾𝚁𝚃 💕⚡", url="t.me/FRIENDS_CHATTING_ZONE_II"),
            ],
            ]
...
async def clone(bot: app, msg: Message):
    ...
    try:
        ...
        await msg.reply(f" 𝐉𝐀 𝐏𝐄𝐋 𝐃𝐄 𝐒𝐀𝐁𝐊𝐎 𝐀𝐁 𝐃𝐄𝐌𝐎𝐍 𝐊𝐎 𝐁𝐀𝐀𝐏 𝐁𝐎𝐋𝐊𝐄 𝐉𝐀𝐀𝐍𝐀 🥵 {user.first_name} 💨.")
